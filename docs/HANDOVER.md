...
4. `docs/SANDBOX_INTEGRATION.md` — how to plug your GST / UPI / AA / EPFO / Electricity / Fuel / Digital Footprint endpoints.
...
- **Sandbox base URLs + credentials** for all 7 alternative data sources (see `docs/SANDBOX_INTEGRATION.md`).
